      ...
      <div className="w-full flex items-center justify-center">
        ...
        <div className="w-full  flex flex-col items-start gap-4">
          <div className="w-full flex items-center justify-between">
            ...
            <div className="w-[650px] pl-[20px] pr-[50px] flex flex-wrap items-center justify-start gap-8">
              <div className="w-[200px] flex gap-2 flex-wrap">
                {data.flowerPrice.price.map((item: any) => (
                  <div>{item.toLocaleString()}원</div>
                ))}
              </div>
              <div className="flex-shrink-0 self-start">
                {data.flowerPrice.option.map((item: any) => (
                  <div
                    className={cn({
          ...
          <div className="w-full flex items-center justify-between">
            ...
            <div className="w-[650px] pl-[20px] pr-[50px] flex flex-wrap items-center justify-start gap-8">
              <div className="w-[200px] flex gap-2 flex-wrap">
                {data.snapPhoto.price.map((item: any) => (
                  <div>{item.toLocaleString()}원</div>
                ))}
              </div>
              <div className="flex-shrink-0 self-start">
                {data.snapPhoto.option.map((item: any) => (
                  <div
                    className={cn({
                      "text-red-400": item !== "선택",
                      "text-gray-500": item === "선택",
          ...
          <div className="w-full flex items-center justify-between">
            ...
            <div className="w-[650px] pl-[20px] pr-[50px] flex flex-wrap items-center justify-start gap-8">
              <div className="w-[200px] flex gap-2 flex-wrap">
                {data.pyeback.price.map((item: any) => (
                  <div>{item.toLocaleString()}원</div>
                ))}
              </div>
              <div className="flex-shrink-0 self-start">
                {data.pyeback.option.map((item: any) => (
                  <div
                    className={cn({
                      "text-red-400": item !== "선택",
                      "text-gray-500": item === "선택",
          ...
          <div className="w-full flex items-center justify-between">
            ...
            <div className="w-[650px] pl-[20px] pr-[50px] flex flex-wrap items-center justify-start gap-8">
              ...
              <div className="flex-shrink-0 self-start">
                {data.flowerWrapping.option.map((item: any) => (
                  <div
                    className={cn({
                      "text-red-400": item !== "선택",
                      "text-gray-500": item === "선택",
          ...
          <div className="w-full flex items-center justify-between">
            ...
            <div className="w-[650px] pl-[20px] pr-[50px] flex flex-wrap items-center justify-start gap-8">
              <div className="w-[200px] flex gap-2 flex-wrap">
                {data.flowerShower.price.map((item: any) => (
                  <div>{item.toLocaleString()}원</div>
                ))}
              </div>
              <div className="flex-shrink-0 self-start">
                {data.flowerShower.option.map((item: any) => (
                  <div
                    className={cn({
                      "text-red-400": item !== "선택",
                      "text-gray-500": item === "선택",
          ...
          <div className="w-full flex items-center justify-between">
            ...
            <div className="w-[650px] pl-[20px] pr-[50px] flex flex-wrap items-center justify-start gap-8">
              <div className="w-[200px] flex gap-2 flex-wrap">
                {data.photoBooth.price.map((item: any) => (
                  <div>{item.toLocaleString()}원</div>
                ))}
              </div>
              <div className="flex-shrink-0 self-start">
                {data.photoBooth.option.map((item: any) => (
                  <div
                    className={cn({
                      "text-red-400": item !== "선택",
                      "text-gray-500": item === "선택",
          ...
          <div className="w-full flex items-center justify-between">
            ...
            <div className="w-[650px] pl-[20px] pr-[50px] flex flex-wrap items-center justify-start gap-8">
              <div className="w-[200px] flex gap-2 flex-wrap">
                {data.officiant.price.map((item: any) => (
                  <div>{item.toLocaleString()}원</div>
                ))}
              </div>
              <div className="flex-shrink-0 self-start">
                {data.officiant.option.map((item: any) => (
                  <div
                    className={cn({
                      "text-red-400": item !== "선택",
                      "text-gray-500": item === "선택",
          ...
          <div className="w-full flex items-center justify-between">
            ...
            <div className="w-[650px] pl-[20px] pr-[50px] flex flex-wrap items-center justify-start gap-8">
              <div className="w-[200px] flex gap-2 flex-wrap">
                {data.mc.price.map((item: any) => (
                  <div>{item.toLocaleString()}원</div>
                ))}
              </div>
              <div className="flex-shrink-0 self-start">
                {data.mc.option.map((item: any) => (
                  <div
                    className={cn({
                      "text-red-400": item !== "선택",
                      "text-gray-500": item === "선택",
          ...
          <div className="w-full flex items-center justify-between">
            ...
            <div className="w-[650px] pl-[20px] pr-[50px] flex flex-wrap items-center justify-start gap-8">
              <div className="w-[200px] flex gap-2 flex-wrap">
                {data.weddingSong.price.map((item: any) => (
                  <div>{item.toLocaleString()}원</div>
                ))}
              </div>
              <div className="flex-shrink-0 self-start">
                {data.weddingSong.option.map((item: any) => (
                  <div
                    className={cn({
                      "text-red-400": item !== "선택",
                      "text-gray-500": item === "선택",
